...
class ViewController: UIViewController {
    ...
    func createHtml(adParams: String, mediaUrl: String) -> String{
        return String(format:
            ...
            "</script>" +
            "</head> " +
            "<body></body></html>", adBrokerUrl, adParams)
    }
